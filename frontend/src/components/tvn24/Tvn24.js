        ...
        <div className="">
           ...
           <div>
            ...
            <div>
                ...
                <h3><FcClock />{newsList.time[4].slice(-4)}</h3>
            </div>
        </div>
    )
}
